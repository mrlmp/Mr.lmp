...
figlet MR.LMP| lolcat

echo -e  "_____________________________________________________________"
echo -e  "Tools    : Army Cyber Nglegok $white         " |lolcat
echo -e  "Creadby  : MR. LMP$white   " |lolcat
echo -e  "Contact  : MR.LMP@gmail.com $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : MR.LMP" | lolcat
exit
;;
